...
if __name__ == '__main__':
    ...
    parser.add_argument('--landmark_dir', type=str, help='Path to landmark files')
    parser.add_argument('--out_dir', type=str, help='Output directory for cropped videos')
    parser.add_argument('--file_list', type=str, help='file list')
    parser.add_argument('--meanface_path', type=str, default='./models/20words_mean_face.npy', help='Path to 20words_mean_face.npy')
