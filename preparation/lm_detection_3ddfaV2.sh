#!/bin/bash
#SBATCH --job-name=lm_detection_3ddfaV2 # Kurzname des Jobs
...
out_dir="/nfs/scratch/staff/simicch/00_data/02_LRS3/prep_test_repo/landmarks_3ddfaV2"
...
echo "start"
echo "lm_detection_3ddfaV2.py"
echo ""
srun python lm_detection_3ddfaV2.py \
	--lrs3 ${lrs3}  \
	--prep_dir ${prep_dir}  \
	--file_list ${file_list}  \
	--out_dir ${out_dir}  \
