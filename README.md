...
3a. {Whisper_model}__train02_finetune_AV_Fusion.yaml - Load results of step 2. and set the learning rate decay 'lr_decay_per_epoch' to 10<sup>1/4</sup> (Stop if no further improvement is achieved on the valid set)


To full fine-tune the AV fusion module and the Whisper model:

3b. {Whisper_model}__train03_fullfinetune_AV_Fusion_Whisper.yaml - Load results of step 2. and set the learning rate decay 'lr_decay_per_epoch' to 10<sup>1/4</sup> (Stop if no further improvement is achieved on the valid set)
